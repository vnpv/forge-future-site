            ...
            <div className="week-body">
              ...
              <p className="week-result">
                ...
                <span className="week-result-highlight">
                  аватар для Дискорда або скін для гри
                </span>
          ...
          <div className="week">
            ...
            <div className="week-body">
              ...
              <p className="week-result">
                В кінці тижня в тебе є:{" "}
                <span className="week-result-highlight">
                  комікс про персонажа з улюбленої гри
                </span>{" "}
          ...
          <div className="week">
            ...
            <div className="week-body">
              ...
              <p className="week-result">
                ...
                якого можна дати другові — наприклад, бот з балами за виконані
                завдання.
              </p>
              <p className="week-training">
          ...
          <div className="week">
            ...
            <div className="week-body">
              ...
              <p className="week-result">
                В кінці тижня в тебе є:{" "}
                <span className="week-result-highlight">
                  сайт-гайд «як обрати комп» або огляд ігор
                </span>{" "}
                — про те, що тобі справді цікаво.
              </p>
              <p className="week-training">
                Що тренуємо: ініціативу. З цього тижня готових варіантів
                більше немає — тільки своє. Застряг — ведучий завжди підкаже.
              </p>
            </div>
          </div>
          ...
          <div className="week">
            ...
            <div className="week-body">
              ...
              <p className="week-result">
                В кінці тижня в тебе є:{" "}
                <span className="week-result-highlight">
                  огляд гри чи фільму власним голосом
                </span>{" "}
                — або озвучена історія.
              </p>
              <p className="week-training">
          ...
          <div className="wrap wrap-prose">
            ...
            <div className="how-block">
              ...
              <p>
                ...
                спробував». Оцінкових слів у студії немає. Говорити швидше,
                ніж встигаєш подумати, збиватися, повторювати слово —
                нормально: тут оцінюють не те, як ти говориш, а що ти зробив.
                За шість тижнів у дитини близько дванадцяти публічних
                виступів — страх оцінки не пропрацьовується розмовами, він
                стирається повторами.
              </p>
            </div>
